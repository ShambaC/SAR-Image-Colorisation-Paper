...
To filter out speckles, we use Lee method of speckle filtering. It employs a sample mean and variance of of pixels in scanning window going over the image.
